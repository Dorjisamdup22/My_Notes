...
Button(root, text="Add", fg="red", font=("Times New Roman",11), command=lambda: messagebox.showinfo('Result',f"The sum is: {first_num.get()+second_num.get()}")).grid(row=4, column=0, padx=18, pady=10, sticky=EW)
