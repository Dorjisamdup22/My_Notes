...
Button(root, text="Convert", bg='gray', fg='red', command=nu_usd).grid(row=4, column=2, rowspan=2, sticky=EW)
...
Button(root, text="Convert", bg='gray', fg='red', command=km_miles).grid(row=9, column=2, rowspan=2, sticky=EW)
